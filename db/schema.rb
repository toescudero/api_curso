...
ActiveRecord::Schema.define(version: 20_191_204_153_320) do
  ...
  create_table 'ranks_challenges', primary_key: %w[challenge_id person_id], force: :cascade do |t|
  ...
  create_table 'ranks_courses', primary_key: %w[course_id person_id], force: :cascade do |t|
    t.serial   'id',         null: false
    t.integer  'person_id',  null: false
    t.integer  'course_id',  null: false
    t.boolean  'teacher'
